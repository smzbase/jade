...
ArrowStyleCombo::ArrowStyleCombo(DrawingArrow::Style style) : QComboBox()
{
...
void ArrowStyleCombo::setStyle(DrawingArrow::Style style)
{
	setCurrentIndex((int)style);
}

DrawingArrow::Style ArrowStyleCombo::style() const
{
	return (DrawingArrow::Style)currentIndex();
}
...
GridStyleCombo::GridStyleCombo(DrawingWidget::GridStyle style) : QComboBox()
{
	addItem("None");
	addItem("Dotted");
	addItem("Lined");
...
void GridStyleCombo::setStyle(DrawingWidget::GridStyle style)
{
	setCurrentIndex((int)style);
}

DrawingWidget::GridStyle GridStyleCombo::style() const
{
	return (DrawingWidget::GridStyle)currentIndex();
}
