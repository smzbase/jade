...
public:
	ArrowStyleCombo(DrawingArrow::Style style = DrawingArrow::None);
	~ArrowStyleCombo();
...
public:
	GridStyleCombo(DrawingWidget::GridStyle style = DrawingWidget::GridDots);
	~GridStyleCombo();

public slots:
	void setStyle(DrawingWidget::GridStyle style);

public:
	DrawingWidget::GridStyle style() const;
};
